...
urlpatterns = [
    ...
    path("testwebscraper/", views.testwebscraper, name="testwebscraper"),
    path("update_webscaper_url/<int:movie_id>", views.update_webscraper_url, name="update_webscaper_url"),
    ...
    path("popup_select_movie/<int:watchlist_id>/", views.popup_select_movie, name="popup_select_movie_watchlist"), # Watchlist page select movie
    path("popup_catalog_select/", views.popup_catalog_select, name="popup_catalog_select"), # Catalog page select movie
